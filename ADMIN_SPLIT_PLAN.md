...
| `services/admin_form_service.py` | `parse_uploaded_form_definition`, `normalize_admin_form_definition`, `validate_admin_form_config`, `build_form_definition_from_admin_form`, `sync_form_fields`, `detect_form_fields`, `normalize_field_stage` |
| `services/admin_template_import_service.py` | `build_definition_from_html`, `build_definition_from_docx`, `read_uploaded_template_file`, `html_attr`, `humanize_field_name` |
| `services/admin_mail_context_service.py` | `build_mail_context`, `render_mail_text`, `preview_mail_context`, `mail_template_type_score` |

## Kolejnosc

1. Przeniesc czyste helpery formularzy do `services/admin_form_service.py`.
